...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h4706c146a53bcac9: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h6176bb9fbdea810e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__ha7454c104c64656a: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h3cd3269e589eb6aa: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h30e1256c9dd0570e: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h759d4aca4e103609: (a: number, b: number, c: number) => void;
