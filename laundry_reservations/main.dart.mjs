...
_1674: (decoder, codeUnits) => decoder.decode(codeUnits),
_1675: () => new TextDecoder("utf-8", {fatal: true}),
_1676: () => new TextDecoder("utf-8", {fatal: false}),
_1677: v => v.toString(),
...
_1715: a => a.join(''),
_1716: (o, a, b) => o.replace(a, b),
_1718: (s, t) => s.split(t),
_1719: s => s.toLowerCase(),
_1720: s => s.toUpperCase(),
_1721: s => s.trim(),
_1722: s => s.trimLeft(),
_1723: s => s.trimRight(),
_1725: (s, p, i) => s.indexOf(p, i),
_1726: (s, p, i) => s.lastIndexOf(p, i),
_1727: (s) => s.replace(/\$/g, "$$$$"),
_1728: Object.is,
...
_1738: (a, s) => a.join(s),
_1739: (a, s, e) => a.slice(s, e),
_1741: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1742: a => a.length,
_1744: (a, i) => a[i],
_1745: (a, i, v) => a[i] = v,
...
_1748: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1749: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1750: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1751: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_1752: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_1753: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_1754: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1756: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_1757: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_1758: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_1759: (t, s) => t.set(s),
_1761: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_1763: o => o.buffer,
_1764: o => o.byteOffset,
_1765: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_1766: (b, o) => new DataView(b, o),
_1767: (b, o, l) => new DataView(b, o, l),
_1768: Function.prototype.call.bind(DataView.prototype.getUint8),
_1769: Function.prototype.call.bind(DataView.prototype.setUint8),
_1770: Function.prototype.call.bind(DataView.prototype.getInt8),
_1771: Function.prototype.call.bind(DataView.prototype.setInt8),
_1772: Function.prototype.call.bind(DataView.prototype.getUint16),
_1773: Function.prototype.call.bind(DataView.prototype.setUint16),
_1774: Function.prototype.call.bind(DataView.prototype.getInt16),
_1775: Function.prototype.call.bind(DataView.prototype.setInt16),
_1776: Function.prototype.call.bind(DataView.prototype.getUint32),
_1777: Function.prototype.call.bind(DataView.prototype.setUint32),
_1778: Function.prototype.call.bind(DataView.prototype.getInt32),
_1779: Function.prototype.call.bind(DataView.prototype.setInt32),
_1782: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_1783: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_1784: Function.prototype.call.bind(DataView.prototype.getFloat32),
_1785: Function.prototype.call.bind(DataView.prototype.setFloat32),
_1786: Function.prototype.call.bind(DataView.prototype.getFloat64),
_1787: Function.prototype.call.bind(DataView.prototype.setFloat64),
...
_1850: (x0,x1) => x0.test(x1),
_1851: (x0,x1) => x0.exec(x1),
_1852: (x0,x1) => x0.exec(x1),
_1853: x0 => x0.pop(),
_1857: (x0,x1,x2) => x0[x1] = x2,
_1859: o => o === undefined,
_1860: o => typeof o === 'boolean',
_1861: o => typeof o === 'number',
_1863: o => typeof o === 'string',
_1866: o => o instanceof Int8Array,
_1867: o => o instanceof Uint8Array,
_1868: o => o instanceof Uint8ClampedArray,
_1869: o => o instanceof Int16Array,
_1870: o => o instanceof Uint16Array,
_1871: o => o instanceof Int32Array,
_1872: o => o instanceof Uint32Array,
_1873: o => o instanceof Float32Array,
_1874: o => o instanceof Float64Array,
_1875: o => o instanceof ArrayBuffer,
_1876: o => o instanceof DataView,
_1877: o => o instanceof Array,
_1878: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1880: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1881: o => o instanceof RegExp,
_1882: (l, r) => l === r,
_1883: o => o,
_1884: o => o,
_1885: o => o,
...
_1892: l => arrayFromDartList(Int8Array, l),
_1893: (data, length) => {
...
_1894: l => arrayFromDartList(Uint8ClampedArray, l),
_1895: l => arrayFromDartList(Int16Array, l),
_1896: l => arrayFromDartList(Uint16Array, l),
_1897: l => arrayFromDartList(Int32Array, l),
_1898: l => arrayFromDartList(Uint32Array, l),
_1899: l => arrayFromDartList(Float32Array, l),
_1900: l => arrayFromDartList(Float64Array, l),
_1901: (data, length) => {
...
_1902: l => arrayFromDartList(Array, l),
_1903:       (s, length) => {
        if (length == 0) return '';
...
_1925: (x0,x1) => x0[x1],
_1928: x0 => x0.flags,
_1929: x0 => x0.multiline,
_1930: x0 => x0.ignoreCase,
_1931: x0 => x0.unicode,
_1932: x0 => x0.dotAll,
_1933: (x0,x1) => x0.lastIndex = x1,
_2036: (x0,x1) => x0.withCredentials = x1,
_2038: x0 => x0.responseURL,
_2039: x0 => x0.status,
_2040: x0 => x0.statusText,
_2042: (x0,x1) => x0.responseType = x1,
_2043: x0 => x0.response,
_3855: () => globalThis.window,
_3920: x0 => x0.navigator,
_4184: x0 => x0.localStorage,
_4311: x0 => x0.userAgent,
_4531: x0 => x0.length
    };
